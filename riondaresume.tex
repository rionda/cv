...
\begin{list2}
%\vspace*{.05in}
\item Doctoral Dissertation: {\em Sampling-based randomized algorithms for big data analytics}
...
\newblock{\em Computer Science and Artificial Intelligence Laboratory, MIT},
04/10/2014.
...
\section{\sc Service}
{\bf External/Sub- reviewer for the following conferences}
\begin{list2}
\vspace*{.05in}
